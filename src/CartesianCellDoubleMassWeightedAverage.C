...
tbox::StartupShutdownManager::Handler CartesianCellDoubleMassWeightedAverage::s_initialize_handler(
...
boost::shared_ptr<tbox::Timer> CartesianCellDoubleMassWeightedAverage::t_coarsen;
...
hier::IntVector
CartesianCellDoubleMassWeightedAverage::getStencilWidth( const tbox::Dimension &dim) const {
...
void CartesianCellDoubleMassWeightedAverage::initializeCallback()
{
    t_coarsen = tbox::TimerManager::getManager()->
        getTimer("CartesianCellDoubleMassWeightedAverage::t_coarsen");
}
