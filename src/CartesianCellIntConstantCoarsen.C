...
tbox::StartupShutdownManager::Handler CartesianCellIntConstantCoarsen::s_initialize_handler(
...
{
    const boost::shared_ptr<pdat::CellVariable<int> > cast_var(var, boost::detail::dynamic_cast_tag());
...
hier::IntVector
CartesianCellIntConstantCoarsen::getStencilWidth( const tbox::Dimension &dim) const {
        ...
        const hier::IntVector& ratio) const
{
    ...
    boost::shared_ptr<pdat::CellData<int> > fdata(fine.getPatchData(src_component), boost::detail::dynamic_cast_tag());
    boost::shared_ptr<pdat::CellData<int> > cdata(coarse.getPatchData(dst_component), boost::detail::dynamic_cast_tag());
...
{
    t_coarsen = tbox::TimerManager::getManager()->
        getTimer("CartesianCellIntConstantCoarsen::t_coarsen");
}
