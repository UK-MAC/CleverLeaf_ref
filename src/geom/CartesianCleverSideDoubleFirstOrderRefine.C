...
//////////////////////////////////////////////////////////////////////////////
#include "CartesianCleverSideDoubleFirstOrderRefine.h"

#include "pdat/CleverSideData.h"
...
int CartesianCleverSideDoubleFirstOrderRefine::getOperatorPriority() const
{
  return 0;
}

SAMRAI::hier::IntVector 
CartesianCleverSideDoubleFirstOrderRefine::getStencilWidth(
  const SAMRAI::tbox::Dimension &dim) const
{
  return SAMRAI::hier::IntVector::getZero(dim);
}

void CartesianCleverSideDoubleFirstOrderRefine::refine(
    ...
    const SAMRAI::hier::IntVector& ratio) const
{
  ...
  std::shared_ptr<clever::pdat::CleverSideData<double> > cdata(
      SHARED_PTR_CAST(clever::pdat::CleverSideData<double>,
        coarse.getPatchData(src_component)));

  std::shared_ptr<clever::pdat::CleverSideData<double> > fdata(
      SHARED_PTR_CAST(clever::pdat::CleverSideData<double>,
